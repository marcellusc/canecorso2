...
if( ! defined( 'WTWP_VERSION' ) ) {
	define( 'WTWP_VERSION', '3.1.2' ); // Version of plugin
}
...
if( ! defined( 'WTWP_PLUGIN_LINK_UPGRADE' ) ) {
	define( 'WTWP_PLUGIN_LINK_UPGRADE', 'https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=Testimonials&utm_campaign=Upgrade-PRO#wpos-epb' ); // Plugin Check link
}
